...
contract StableLoanToken is ERC20, Ownable, ILendingToken {
    // Token value in ETH (0.25 ETH)
    uint256 private constant _TOKEN_VALUE = 250000000000000000;
    
    // Interest rate in basis points (5% annual = 500 basis points)
    uint256 private constant _INTEREST_RATE = 500;
    
    constructor() ERC20("Stable Loan Token", "SLT") Ownable(msg.sender) {}
