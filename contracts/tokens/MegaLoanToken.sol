...
contract MegaLoanToken is ERC20, Ownable, ILendingToken {
    // Token value in ETH (1.0 ETH)
    uint256 private constant _TOKEN_VALUE = 1000000000000000000;
    
    // Interest rate in basis points (18% annual = 1800 basis points)
    uint256 private constant _INTEREST_RATE = 1800;
    
    constructor() ERC20("Mega Loan Token", "MLT") Ownable(msg.sender) {}
